...
//         </svg>
//       ),
//       action: () => console.log("Book Demo clicked")
//     },
//     {
...
//         </svg>
//       ),
//       action: () => console.log("Product Customization clicked")
//     },
//     {
...
//         </svg>
//       ),
//       action: () => console.log("Business Engagements clicked")
//     },
//     {
//       title: "Investment",
...
//         </svg>
//       ),
//       action: () => console.log("Investment clicked")
//     }
//   ];
...
//               Choose how you'd like to engage with us. If you're unsure, you can also reach out using the general inquiry form below.
//             </p>
//           </div>
//         </section>
...
//                   <div className="relative p-6 rounded-2xl bg-gray-900/40 backdrop-blur-xl border border-white/10 hover:border-purple-500/30 transition-all duration-300 h-full flex flex-col">
//                     <div className="mb-4 inline-flex p-3 rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-400 w-fit">
//                       {option.icon}
//                     </div>
//                     <h3 className="text-xl font-bold text-white mb-3">{option.title}</h3>
//                     <p className="text-gray-400 leading-relaxed flex-grow">{option.description}</p>
//                     <div className="mt-4 flex items-center gap-2 text-purple-400 font-semibold group-hover:gap-3 transition-all">
//                       <span>Connect</span>
...
//               For questions that don't fall under the options above, feel free to reach out using the form below.
//             </p>
//           </div>
//         </section>
...
//                   <p className="text-gray-400">We'll review your message and respond as soon as possible.</p>
//                 </div>
      ...
      <main className="min-h-screen bg-black pt-20">
        ...
        <section className="relative w-full py-24 md:py-32 overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
              Choose how you wouldd like to engage with us. If you are unsure, you can also reach out using the general inquiry form below.
            </p>
          </div>
        </section>
