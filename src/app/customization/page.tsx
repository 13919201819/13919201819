...
export default function CustomizationPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      console.log('1. Preparing to send data:', formData);
      
      console.log('2. Making fetch request to http://localhost:3000/api/send-email');
      
      const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'https://connect-2-gamma.vercel.app';
      const response = await fetch(`${apiUrl}/api/customization-submit`, {
        method: 'POST',
        mode: 'cors',
        credentials: 'omit',
        headers: {
      ...
      console.log('4. Response parsed:', result);

      if (!response.ok) {
        throw new Error(result.error || 'Failed to submit customization request');
      }
  ...
  return (
    <>
      ...
      {/* MAIN SECTION */}
      <section className="relative w-full min-h-screen pt-24 sm:pt-28 mt-12 md:pt-32 pb-16 sm:pb-24 md:pb-40 overflow-hidden bg-gradient-to-b from-black via-purple-950/10 to-black">
        {/* Background */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center space-y-4 sm:space-y-6 mb-10 sm:mb-14 md:mb-16">
            ...
            <p className="max-w-3xl mx-auto text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed px-4">
              ...
              organization&apos;s data, processes, and scale.
            </p>
          </div>
