...
export default function StrategicPartnershipPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('https://connect-2-gamma.vercel.app/api/strategic-partnership', {
        method: 'POST',
        headers: {
      ...
      alert("❌ Failed to submit partnership request. Please try again or contact support.");
    } finally {
  ...
  return (
    <>
      <Header />
      <section className="relative w-full min-h-screen py-24 mt-18 overflow-hidden bg-gradient-to-b from-black via-purple-950/10 to-black">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="organizationType" className="flex items-center gap-2 text-white font-medium text-sm">
                        <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-6 pt-4">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <label htmlFor="initiativeType" className="flex items-center gap-2 text-white font-medium text-sm">
                        <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
